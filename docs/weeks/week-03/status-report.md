...
| Conor Driscoll | 3 |
| Adrian Czerwonka | 3 |
| Idrees Abdurrazzak | 3 |

## Completed Tasks from Last Week – (Task Owner)

| Task | Owner |
| --- | --- |
| Finalize technology stack selection (frontend framework, backend) | All |
| Set up project repository | Conor Driscoll |
| Begin Gantt chart / project timeline | Idrees Abdurrazzak |
| Defined high-level database schema (users, boards, widgets, api_logs) | All |
| Use Case Diagram | Adrian Czerwonka |
...
| Task | Owner |
| --- | --- |
| Prototype / Wireframe | All |
| Start Wiki | Adrian Czerwonka |
| Figuring out Project name we will use for our site | All |
...
- Update Project Proposal based on Professor's feedback
...
| Action | Responsible |
| --- | --- |
| Re-Submit project proposal to Canvas by Thursday 4/8 | All |
| Schedule team meeting over discord to finalize tech stack | All |
| Continuing task from Week 3 | All |
