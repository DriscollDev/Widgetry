...
| --- | --- | --- |
| Conor Driscoll | 4 | 12 |
| Adrian Czerwonka | 4 | 12 |
| Idrees Abdurrazzak | 4 | 12 |

## Completed Tasks from Last Week – (Task Owner)

| Task | Owner |
| --- | --- |
| Midterm Presentation built and submitted | Idrees Abdurrazzak |
| GitHub repository folder structure initiated | Conor Driscoll |
| Database schema designed and finalized (PostgreSQL, 6 tables) | Conor / Idrees |
| Agreed on project / site name (Widgetry) | All |
| ERD submitted | Conor Driscoll |
| Wireframes reviewed and signed off by team | All |
| Gantt Chart updated | Idrees Abdurrazzak |

## Budget

| Planned Time | Actual Time | Remaining Hours in Budget |
| --- | --- | --- |
| 4 Hours (Week 5) | 12 Hours | Ongoing |
...
- Team meetings need to be more consistent. Earlier check-ins required.
