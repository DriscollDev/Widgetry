...
>
  {#snippet content()}
    ...
    <div class="max-h-[60vh] overflow-y-auto p-5">
      {#if atLimit}
        <p
          class="rounded-lg border border-surface-200-800 bg-surface-100-900 p-4 text-sm text-surface-600-400"
        >
          This board already has {MAX_WIDGETS_PER_BOARD} widgets, the most a board can hold. Remove one
          to add another.
        </p>
